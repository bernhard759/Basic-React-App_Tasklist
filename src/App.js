    ...
    <>
      <center><img src={logo} alt="logo" style={{ marginBottom: "2rem" }} />
        <div>
          ...
          <button onClick={handleAddTask} style={{ marginLeft: "1rem", marginTop: "0.5rem" }}>Add todo</button>
          <button onClick={handleClearTasks} style={{ marginLeft: "1rem", marginTop: "0.5rem" }}>Clear completed todos</button>
        </div>
      </center>
      <center>
